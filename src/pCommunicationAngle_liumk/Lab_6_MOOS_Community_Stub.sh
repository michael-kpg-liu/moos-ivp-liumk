...
echo "Starting Communications Stub"
...
uPokeDB pCommunicationAngle_liumk.moos NEPTUNE_NAV_Y=15000.0
uPokeDB pCommunicationAngle_liumk.moos NEPTUNE_NAV_DEPTH=1500.0
uPokeDB pCommunicationAngle_liumk.moos NEPTUNE_NAV_SPEED=0.0
uPokeDB pCommunicationAngle_liumk.moos NEPTUNE_NAV_HEADING=15.0
uPokeDB pCommunicationAngle_liumk.moos COLLABORATOR_NAME="NEPTUNE"

echo "All updates posted"
