...
nsplug meta_vehicle_fld.bhv targ_$VNAME.bhv -f VNAME=$VNAME      \
    START_POS=$START_POS                                     \
    LOITER_CENTER_X=$LOITER_CENTER_X                         \
    LOITER_CENTER_Y=$LOITER_CENTER_Y                         \
